...
bounty-description-carp = Admiral Pavlov has gone on strike ever since Claw Command confiscated her "pet." She is demanding a space carp as a replacement, dead or alive.
...
bounty-description-handcuffs = A large influx of escaped convicts have arrived at Claw Command. Now is the perfect time to ship out spare handcuffs (or restraints).
...
bounty-description-monkey-cube = Due to a recent genetics accident, Claw Command is in serious need of monkeys. Your mission is to ship monkey cubes.
...
bounty-description-research-disk = Turns out those bozos in the Research department have been spending all their time getting janitorial equipment. Send some research up to Claw Command so we can actually get what we need.
...
bounty-description-toolbox = There's an absence of robustness at Claw Command. Hurry up and ship some toolboxes as a solution.
