...
using Content.Shared._ClawCommand.DelayedDeath;
...
public partial class DelayedDeathSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var ent, out var component, out var mob))
        {
            component.DeathTimer += frameTime;

            if (component.DeathTimer >= component.DeathTime && !_mobState.IsDead(ent, mob))
            {
