...
public sealed partial class SupermatterSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        // CVar subscriptions
        Subs.CVar(_config, CCVars.SupermatterSingulooseMolesModifier, value => SupermatterSingulooseMolesModifier = value, true);
        Subs.CVar(_config, CCVars.SupermatterDoSingulooseDelam, value => SupermatterDoSingulooseDelam = value, true);
        Subs.CVar(_config, CCVars.SupermatterTesloosePowerModifier, value => SupermatterTesloosePowerModifier = value, true);
        Subs.CVar(_config, CCVars.SupermatterDoTeslooseDelam, value => SupermatterDoTeslooseDelam = value, true);
        Subs.CVar(_config, CCVars.SupermatterDoForceDelam, value => SupermatterDoForceDelam = value, true);
        Subs.CVar(_config, CCVars.SupermatterForcedDelamType, value => SupermatterForcedDelamType = value, true);
        Subs.CVar(_config, CCVars.SupermatterRadsBase, value => SupermatterRadsBase = value, true);
        Subs.CVar(_config, CCVars.SupermatterRadsModifier, value => SupermatterRadsModifier = value, true);
        Subs.CVar(_config, CCVars.SupermatterYellTimer, value => SupermatterYellTimer = value, true);
