...
using System.Text;
using Content.Server._ClawCommand.devil.Roles;
...
namespace Content.Server._ClawCommand.devil.GameTicking.Rules;
...
public sealed class DevilRuleSystem : GameRuleSystem<DevilRuleComponent>
{
    ...
    {
        if (!TryComp<MindComponent>(role.Owner, out var mind) || mind.OwnedEntity == null)
            return;
